...
还有一些利用 solt 插槽或者 ref 实例进行通信的方法，因为使用场景过于有限不再赘述。

> 推荐阅读：[vue 中 8 种组件通信方式](https://juejin.im/post/5d267dcdf265da1b957081a3)
>
> 太偏门的通信方式根本不会用到，单做知识点了解即可
...
> 推荐阅读：详细对比与实现请见 [Proxy 比 defineproperty 优劣对比？](https://www.cxymsg.com/guide/devsProxy.html)
